...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 text-dark fw-bold">Tambah Pengguna Baru</h2>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="username" name="username" placeholder="Masukkan username" value="<?= old(
                            	'username'
                            ) ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="contoh@perusahaan.com" value="<?= old(
                            	'email'
                            ) ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="confpassword" class="form-label fw-bold">Konfirmasi Password <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_divisi" name="nama_divisi" placeholder="Contoh: Finance & Accounting" value="<?= old(
                            	'nama_divisi'
                            ) ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Contoh: Staff AP" value="<?= old(
                            	'jabatan'
                            ) ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="role_id" name="role_id" required>
                                <option value="" disabled <?= old('role_id')
                                	? ''
                                	: 'selected' ?>>-- Pilih Hak Akses --</option>
